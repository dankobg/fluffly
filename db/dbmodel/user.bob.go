...
type userPreloader struct {
	UserContact func(...psql.PreloadOption) psql.Preloader
}

func buildUserPreloader() userPreloader {
	return userPreloader{
		UserContact: func(opts ...psql.PreloadOption) psql.Preloader {
			return psql.Preload[*UserContact, UserContactSlice](psql.PreloadRel{
				Name: "UserContact",
			...
			}, UserContacts.Columns.Names(), opts...)
		},
	}
}
...
type userThenLoader[Q orm.Loadable] struct {
	...
	UserContact     func(...bob.Mod[*dialect.SelectQuery]) orm.Loader[Q]
}
...
func buildUserThenLoader[Q orm.Loadable]() userThenLoader[Q] {
	...
	type UserContactLoadInterface interface {
		LoadUserContact(context.Context, bob.Executor, ...bob.Mod[*dialect.SelectQuery]) error
	}
	...
	return userThenLoader[Q]{
		...
		UserContact: thenLoadBuilder[Q](
			"UserContact",
			func(ctx context.Context, exec bob.Executor, retrieved UserContactLoadInterface, mods ...bob.Mod[*dialect.SelectQuery]) error {
				return retrieved.LoadUserContact(ctx, exec, mods...)
			},
		),
	}
}
...
// LoadUserContact loads the user's UserContact into the .R struct
func (o *User) LoadUserContact(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if o == nil {
		return nil
	}
	...
	related, err := o.UserContact(mods...).One(ctx, exec)
	if err != nil {
		return err
	}
	...
	o.R.UserContact = related
	return nil
}

// LoadUserContact loads the user's UserContact into the .R struct
func (os UserSlice) LoadUserContact(ctx context.Context, exec bob.Executor, mods ...bob.Mod[*dialect.SelectQuery]) error {
	if len(os) == 0 {
		return nil
	}

	userContacts, err := os.UserContact(mods...).All(ctx, exec)
	if err != nil {
		return err
	}
...
type userJoins[Q dialect.Joinable] struct {
	...
	UserContact     modAs[Q, userContactColumns]
}
