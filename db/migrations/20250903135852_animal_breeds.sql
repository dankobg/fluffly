...
-- insert cat breeds
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
  values
    ('Abyssinian'),
    ('American Bobtail'),
...
-- insert small and furry breeds (Chinchilla)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Degu)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Ferret)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Gerbil)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Guinea Pig)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Hamster)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Hedgehog)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Mouse)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Prairie Dog)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Rat)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Skunk)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
...
-- insert small and furry breeds (Sugar Glider)
insert into "breed" ("animal_species_id", "name")
select asp."id", b."name"
from "animal_species" asp
cross join (
