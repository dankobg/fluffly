...
type CountryTemplate struct {
	ID         func() int64
	Name       func() string
	IsoAlpha2  func() string
	IsoAlpha3  func() string
	IsoNumeric func() string
...
func (o CountryTemplate) BuildSetter() *models.CountrySetter {
	...
	if o.IsoAlpha2 != nil {
		val := o.IsoAlpha2()
		m.IsoAlpha2 = omit.From(val)
	}
	if o.IsoAlpha3 != nil {
		val := o.IsoAlpha3()
		m.IsoAlpha3 = omit.From(val)
	}
	if o.IsoNumeric != nil {
		val := o.IsoNumeric()
		m.IsoNumeric = omit.From(val)
	}
	if o.CreatedAt != nil {
		val := o.CreatedAt()
...
func (o CountryTemplate) Build() *models.Country {
	...
	if o.IsoAlpha2 != nil {
		m.IsoAlpha2 = o.IsoAlpha2()
	}
	if o.IsoAlpha3 != nil {
		m.IsoAlpha3 = o.IsoAlpha3()
	}
	if o.IsoNumeric != nil {
		m.IsoNumeric = o.IsoNumeric()
	}
	if o.CreatedAt != nil {
...
func ensureCreatableCountry(m *models.CountrySetter) {
	...
	if !(m.IsoAlpha2.IsValue()) {
		val := random_string(nil, "2")
		m.IsoAlpha2 = omit.From(val)
	}
	if !(m.IsoAlpha3.IsValue()) {
		val := random_string(nil, "3")
		m.IsoAlpha3 = omit.From(val)
	}
	if !(m.IsoNumeric.IsValue()) {
		val := random_string(nil, "3")
		m.IsoNumeric = omit.From(val)
	}
}
...
func (m countryMods) RandomizeAllColumns(f *faker.Faker) CountryMod {
	return CountryModSlice{
		...
		CountryMods.RandomIsoAlpha2(f),
		CountryMods.RandomIsoAlpha3(f),
		CountryMods.RandomIsoNumeric(f),
...
// Set the model columns to this value
func (m countryMods) IsoAlpha2(val string) CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoAlpha2 = func() string { return val }
	})
}

// Set the Column from the function
func (m countryMods) IsoAlpha2Func(f func() string) CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoAlpha2 = f
	})
}
...
// Clear any values for the column
func (m countryMods) UnsetIsoAlpha2() CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoAlpha2 = nil
	})
}
...
// Generates a random value for the column using the given faker
// if faker is nil, a default faker is used
func (m countryMods) RandomIsoAlpha2(f *faker.Faker) CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoAlpha2 = func() string {
...
// Set the model columns to this value
func (m countryMods) IsoAlpha3(val string) CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoAlpha3 = func() string { return val }
	})
}

// Set the Column from the function
func (m countryMods) IsoAlpha3Func(f func() string) CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoAlpha3 = f
	})
}
...
// Clear any values for the column
func (m countryMods) UnsetIsoAlpha3() CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoAlpha3 = nil
	})
}
...
// Generates a random value for the column using the given faker
// if faker is nil, a default faker is used
func (m countryMods) RandomIsoAlpha3(f *faker.Faker) CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoAlpha3 = func() string {
...
// Set the model columns to this value
func (m countryMods) IsoNumeric(val string) CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoNumeric = func() string { return val }
	})
}

// Set the Column from the function
func (m countryMods) IsoNumericFunc(f func() string) CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoNumeric = f
	})
}
...
// Clear any values for the column
func (m countryMods) UnsetIsoNumeric() CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoNumeric = nil
	})
}
...
// Generates a random value for the column using the given faker
// if faker is nil, a default faker is used
func (m countryMods) RandomIsoNumeric(f *faker.Faker) CountryMod {
	return CountryModFunc(func(_ context.Context, o *CountryTemplate) {
		o.IsoNumeric = func() string {
			return random_string(f, "3")
		}
	})
}
