...
// WithPrefix creates new IdentityVerifiableAddressesTable with assigned table prefix
func (a IdentityVerifiableAddressesTable) WithPrefix(prefix string) *IdentityVerifiableAddressesTable {
	return newIdentityVerifiableAddressesTable(a.SchemaName(), prefix+a.TableName(), a.TableName())
}

// WithSuffix creates new IdentityVerifiableAddressesTable with assigned table suffix
func (a IdentityVerifiableAddressesTable) WithSuffix(suffix string) *IdentityVerifiableAddressesTable {
	return newIdentityVerifiableAddressesTable(a.SchemaName(), a.TableName()+suffix, a.TableName())
}
