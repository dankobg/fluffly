...
// WithPrefix creates new SchemaMigrationTable with assigned table prefix
func (a SchemaMigrationTable) WithPrefix(prefix string) *SchemaMigrationTable {
	return newSchemaMigrationTable(a.SchemaName(), prefix+a.TableName(), a.TableName())
}

// WithSuffix creates new SchemaMigrationTable with assigned table suffix
func (a SchemaMigrationTable) WithSuffix(suffix string) *SchemaMigrationTable {
	return newSchemaMigrationTable(a.SchemaName(), a.TableName()+suffix, a.TableName())
}
...
func newSchemaMigrationTableImpl(schemaName, tableName, alias string) schemaMigrationTable {
	var (
		...
		defaultColumns    = postgres.ColumnList{VersionSelfColumn}
	)
