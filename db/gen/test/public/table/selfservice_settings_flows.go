...
// WithPrefix creates new SelfserviceSettingsFlowsTable with assigned table prefix
func (a SelfserviceSettingsFlowsTable) WithPrefix(prefix string) *SelfserviceSettingsFlowsTable {
	return newSelfserviceSettingsFlowsTable(a.SchemaName(), prefix+a.TableName(), a.TableName())
}

// WithSuffix creates new SelfserviceSettingsFlowsTable with assigned table suffix
func (a SelfserviceSettingsFlowsTable) WithSuffix(suffix string) *SelfserviceSettingsFlowsTable {
	return newSelfserviceSettingsFlowsTable(a.SchemaName(), a.TableName()+suffix, a.TableName())
}
...
func newSelfserviceSettingsFlowsTableImpl(schemaName, tableName, alias string) selfserviceSettingsFlowsTable {
	var (
		...
		defaultColumns        = postgres.ColumnList{IssuedAtColumn, StateColumn, TypeColumn}
	)
