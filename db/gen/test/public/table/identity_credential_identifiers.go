...
// WithPrefix creates new IdentityCredentialIdentifiersTable with assigned table prefix
func (a IdentityCredentialIdentifiersTable) WithPrefix(prefix string) *IdentityCredentialIdentifiersTable {
	return newIdentityCredentialIdentifiersTable(a.SchemaName(), prefix+a.TableName(), a.TableName())
}

// WithSuffix creates new IdentityCredentialIdentifiersTable with assigned table suffix
func (a IdentityCredentialIdentifiersTable) WithSuffix(suffix string) *IdentityCredentialIdentifiersTable {
	return newIdentityCredentialIdentifiersTable(a.SchemaName(), a.TableName()+suffix, a.TableName())
}
