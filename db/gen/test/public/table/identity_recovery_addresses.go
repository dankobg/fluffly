...
// WithPrefix creates new IdentityRecoveryAddressesTable with assigned table prefix
func (a IdentityRecoveryAddressesTable) WithPrefix(prefix string) *IdentityRecoveryAddressesTable {
	return newIdentityRecoveryAddressesTable(a.SchemaName(), prefix+a.TableName(), a.TableName())
}

// WithSuffix creates new IdentityRecoveryAddressesTable with assigned table suffix
func (a IdentityRecoveryAddressesTable) WithSuffix(suffix string) *IdentityRecoveryAddressesTable {
	return newIdentityRecoveryAddressesTable(a.SchemaName(), a.TableName()+suffix, a.TableName())
}
