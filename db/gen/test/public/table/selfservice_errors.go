...
// WithPrefix creates new SelfserviceErrorsTable with assigned table prefix
func (a SelfserviceErrorsTable) WithPrefix(prefix string) *SelfserviceErrorsTable {
	return newSelfserviceErrorsTable(a.SchemaName(), prefix+a.TableName(), a.TableName())
}

// WithSuffix creates new SelfserviceErrorsTable with assigned table suffix
func (a SelfserviceErrorsTable) WithSuffix(suffix string) *SelfserviceErrorsTable {
	return newSelfserviceErrorsTable(a.SchemaName(), a.TableName()+suffix, a.TableName())
}
...
func newSelfserviceErrorsTableImpl(schemaName, tableName, alias string) selfserviceErrorsTable {
	var (
		...
		defaultColumns  = postgres.ColumnList{CsrfTokenColumn}
	)
