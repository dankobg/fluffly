...
// WithPrefix creates new IdentityVerificationTokensTable with assigned table prefix
func (a IdentityVerificationTokensTable) WithPrefix(prefix string) *IdentityVerificationTokensTable {
	return newIdentityVerificationTokensTable(a.SchemaName(), prefix+a.TableName(), a.TableName())
}

// WithSuffix creates new IdentityVerificationTokensTable with assigned table suffix
func (a IdentityVerificationTokensTable) WithSuffix(suffix string) *IdentityVerificationTokensTable {
	return newIdentityVerificationTokensTable(a.SchemaName(), a.TableName()+suffix, a.TableName())
}
...
func newIdentityVerificationTokensTableImpl(schemaName, tableName, alias string) identityVerificationTokensTable {
	var (
		...
		defaultColumns                      = postgres.ColumnList{UsedColumn}
	)
