...
var Tags = psql.NewTablex[*Tag, TagSlice, *TagSetter]("", "tag")
...
type tagR struct {
	Animal *Animal // tag.fk_tag_animal_id_animal
}
...
var TagErrors = &tagErrors{
	ErrUniqueTagPkey: &UniqueConstraintError{
		schema:  "",
		table:   "tag",
		columns: []string{"id"},
		s:       "tag_pkey",
