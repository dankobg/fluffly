...
func (p *petfinderClient) listOrganizations(ctx context.Context, params listOrganizationsQueryParams) (*http.Response, error) {
	...
	resp, err := p.c.Do(req)
	if err != nil {
		return nil, fmt.Errorf("failed to get list organizations result: %w", err)
	}
...
func (p *petfinderClient) listAnimals(ctx context.Context, params listAnimalsQueryParams) (*http.Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("failed to create list animals request: %w", err)
	}
	...
	resp, err := p.c.Do(req)
	if err != nil {
		return nil, fmt.Errorf("failed to get list animals result: %w", err)
	}
...
func (p *petfinderClient) listTypes(ctx context.Context) (*http.Response, error) {
	u, _ := url.Parse(p.baseURL)
	typesURL := u.JoinPath("types")

	req, err := http.NewRequestWithContext(ctx, http.MethodGet, typesURL.String(), nil)
	if err != nil {
		return nil, fmt.Errorf("failed to create list animal types request: %w", err)
	}
	...
	resp, err := p.c.Do(req)
	if err != nil {
		return nil, fmt.Errorf("failed to get list animal types result: %w", err)
	}
...
func (p *petfinderClient) listBreeds(ctx context.Context, animalType string) (*http.Response, error) {
	u, _ := url.Parse(p.baseURL)
	breedsURL := u.JoinPath("types", animalType, "breeds")

	req, err := http.NewRequestWithContext(ctx, http.MethodGet, breedsURL.String(), nil)
	if err != nil {
		return nil, fmt.Errorf("failed to create list breeds request: %w", err)
	}
	...
	resp, err := p.c.Do(req)
	if err != nil {
		return nil, fmt.Errorf("failed to get list breeds result: %w", err)
	}
